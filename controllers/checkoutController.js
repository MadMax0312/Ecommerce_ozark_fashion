...
const loadCheckout = async (req, res) => {
  try {
    ...
    res.render('checkout', { user: userData, address: userAddress, cart: cartData, totalAmount });
  } catch (error) {
...
const addAddress = async (req, res) => {
  try {
    ...
    const { c_diff_fname, c_diff_mobile, c_diff_postal_state, c_diff_state_district, c_diff_city, c_diff_pincode } = req.body;
