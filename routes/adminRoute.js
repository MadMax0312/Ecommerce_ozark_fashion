...
admin_route.post("/add-products", fileUploadMiddleware.upload.array("images", 4), productController.addProducts);
...
admin_route.post("/edit-product", fileUploadMiddleware.upload.array("images", 4), productController.editProduct);

admin_route.post("/delete-image", productController.deleteImage);

admin_route.post("/add-images", fileUploadMiddleware.upload.array("images", 4), productController.addImages);
